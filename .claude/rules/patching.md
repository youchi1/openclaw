...
# 6. Update bookkeeping and commit:
...
# 10. Update HeadClaw's .env: OPENCLAW_VERSION=NEW_VERSION-patched.1
```
...
- **Upstream version:** 2026.4.12
- **Current patched branch:** `patched/2026.4.12`
