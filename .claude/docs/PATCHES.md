...
- HC-001 - Fix stale skillsSnapshot on new skill install — `19598d5fcb` (was `54a83201f8` on 2026.4.5)
...
- HC-002 - Fix skill watcher not detecting new/removed skills (chokidar v5 glob bug) — `681f93fef9` (was `a802027f21` on 2026.4.5)
...
- HC-003 - Bust OpenAI prompt cache when system prompt changes — `4db9b812a4` (was `c9ee96e422` on 2026.4.5; conflict resolved on 2026.4.11)
...
- HC-004 - Invalidate bootstrap file cache when files change on disk — `c4a4b19ff5` (was `fc7dc508c9` on 2026.4.5)
...
- HC-005 - Suppress NO_REPLY garbage text from context pollution — `56b32f109e`
